...
基于 **PyQt6** 的通用课件导入与刷题桌面应用。支持从 PPTX/PDF/DOCX/Markdown 课件中提取主题、AI 生成双语题目、7 种题型自动判分、进度追踪、中英文纯净切换。
...
2. **AI 出题**（可选）— 设置中配置 API Key，选择主题和数量，AI 生成双语题目并存入题库
...
├── main.py              # 入口
├── config.py            # 路径与默认配置
├── style.qss            # Catppuccin Mocha 深色主题
├── ai/                  # LLM 调用、提示词、批量生成
